...
export const translations = {
  pt: {
    ...
    auth: {
      ...
      termsAccept: 'Eu aceito os Termos de Uso e a Política de Privacidade Local.',
      ...
      termsTitle: 'Compromisso de Segurança',
    },
    playground: {
      configTitle: 'Sua Identidade',
      configDesc: 'Personalize seu explorador e sensores de borda.',
      auraColor: 'Cor da Aura Digital',
      ageGroup: 'Faixa Etária de Exploração',
      syncPlayground: 'Criar Identidade e Jogar',
  ...
  en: {
    ...
    auth: {
      ...
      termsAccept: 'I accept the Terms of Use and Local Privacy Policy.',
      ...
      termsTitle: 'Security Commitment',
    },
    playground: {
      art: 'Art',
      motor: 'Motor',
