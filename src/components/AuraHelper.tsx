...
/**
 * AuraHelper Component - SPSP 2026 Edition.
 * Substitui o FloatingAuraBot com lógica limpa e performance otimizada.
 */
export function AuraHelper() {
            ...
            >
              <div className="p-6 bg-primary/5 border-b flex items-center gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-sm font-black uppercase italic tracking-tighter text-slate-900">Guia UrbeLudo 2026</h3>
                  <p className="text-[8px] font-bold text-muted-foreground uppercase tracking-widest">Sincronia Gemini 3 Ativa</p>
                </div>
              </div>
                ...
                <div className="space-y-4 pb-4">
                  ...
                  {isLoading && (
                    <div className="flex items-center gap-2 p-4 bg-slate-50 rounded-2xl w-fit">
                      ...
                      <span className="text-[8px] font-black uppercase text-muted-foreground">Processando 2026...</span>
                    </div>
                  )}
